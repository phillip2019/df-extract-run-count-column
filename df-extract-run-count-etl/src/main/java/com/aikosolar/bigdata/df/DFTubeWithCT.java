 ...
 */
public class DFTubeWithCT extends DFTube {
     ...
     * 默认构造方法，直接由dfTube填充
     **/
    public DFTubeWithCT(DFTube dfTube) throws InvocationTargetException, IllegalAccessException {
        BeanUtils.copyProperties(this, dfTube);
    }
